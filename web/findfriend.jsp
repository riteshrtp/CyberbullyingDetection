        ...
        <div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
            ...
            <div style="position:absolute; left:400px; top:310px; width: 358px; height: 166px;">
                ...
                <fieldset>
                    ...
                    <legend>
                        <font color="Blue" size="4"><strong>Send Request</strong></font>
                    </legend>
                    <%
                                int fid = 0;
                    ...
                    <form name="f1" ENCTYPE="multipart/form-data" action="#" method="post">
                        ...
                        <table width="318" height="150" align="center">
                            <%while (rs2.next()) {
                                ...
                                %>
                            <tr>
                                <td width="134">Name:&nbsp;&nbsp;<%=rs2.getString("name")%></td>
                            </tr>
                            <tr>
                                <td><img src="viewimage.jsp?id=<%=fid%>" alt="" width="120" height="99" /></td>
                                <td width="109"><a href="request.jsp?id=<%=rid%>">
                                        <font color="Navy" size="3"><strong>Send
                                                Request</strong></font>
                                    </a></td>
                            </tr>
