        ...
        <div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
            ...
            <div style="position:absolute; left:400px; top:310px; width: 358px; height: 316px;">
                ...
                <fieldset>
                    ...
                    <legend>
                        <font color="Blue" size="4"><strong>Notification Alert</strong></font>
                    </legend>
                    <table border="2">
                        <thead>
                            <tr>
                        ...
                        <tr>
                            <td><%=fid%></td>
                            <td><%=word%></td>
                            <td><a href="allow.jsp?word=<%=word%>&buser=<%=fid%>&cuser=<%=name%>">
                                    <font color="Blue">Allow</font>
                                </a></td>
                            <td><a href="deny.jsp">
                                    <font color="Blue">Deny</font>
                                </a></td>
                        </tr>
