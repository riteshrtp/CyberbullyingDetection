                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="status.jsp">
                                <font color="Blue" size="3">Status Update</font>
                            </a></li>
                    ...
                    <fieldset>
                        ...
                        <table align="center" height="150">
                            <%while (rs2.next()) {
                                ...
                                %>
                            <tr>
                                <td>Name:&nbsp;&nbsp;&nbsp;<%=rs2.getString("name")%></td>
                            </tr>
                            <tr>
                                <td><img src="viewimage.jsp?id=<%=fid%>" alt="" width="120" height="99" /></td>
                            </tr>
                            <tr>
                                <td><a href="viewrequest1.jsp?id=<%=rid1%>">
                                        <font color="Navy"><strong>Confirm</strong></font>
                                    </a>&nbsp;&nbsp;&nbsp;<a href="ignore.jsp?id=<%=rid2%>">
                                        <font color="Navy"><strong>Ignore</strong></font>
                                    </a></td>
                            </tr>
                            <%}%>
                            </table>
