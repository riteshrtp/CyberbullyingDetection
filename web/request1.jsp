				...
				<fieldset>
					...
					<legend>
						<font color="Blue"><strong>
								<font size="4">SendRequest</font>
							</strong></font>
					</legend>
					<form name="f1" ENCTYPE="multipart/form-data" action="updaterequest1.jsp" method="post"
						onsubmit="return validation();">

						<table align="center" height="150">
							<tr>
								<td><%=(String)session.getAttribute("fname")%>:Add Relationship</td>
							</tr>
							<tr></tr>
							<tr></tr>
							<tr>
							...
							<tr></tr>
							<tr>
								<td><%=(String)session.getAttribute("fname")%>:Add Group</td>
							</tr>
							<tr></tr>
							<tr></tr>
							<tr>
							...
							<tr>
								<td><input name="submit" type="submit" class="button2" value="Send" /></td>
							</tr>
