    ...
    <div id="content">
        ...
        <div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
            <div style="position:absolute; left:400px; top:331px; width: 358px; height: 140px;">
                <form name="f1" ENCTYPE="multipart/form-data" action="uploadpage1.jsp" method="post"
                    onsubmit="return validation();">
                    <fieldset>

                        <legend>
                            <font color="Blue"><strong>
                                    <font size="4">Image</font>
                                </strong></font>
                        </legend>
                        <table align="center" height="340">
                            <tr>
                                <td>Photo id:&nbsp;&nbsp;&nbsp;<%=(Integer) (session.getAttribute("pid"))%></td>
                            </tr>
                            <tr></tr>
                            <tr></tr>
                            <tr>
                                <td>You are the owner of this photo</td>
                            </tr>
                            <tr></tr>
                            <tr></tr>
                            <tr>
                                <td height="202"><img src="view.jsp?id=<%=(Integer) (session.getAttribute("pid"))%>"
                                        alt="" width="250" height="200" /></td>
                            </tr>
                            <tr></tr>
                            <tr></tr>
                            <tr>
                                <td height="38"><select name="setting">
                            ...
                            <tr></tr>
                            <tr>
                                <td><input name="submit" type="submit" class="button2" value="Save privacy settings" />
                                </td>
                            </tr>
                        </table>
                    </fieldset>
