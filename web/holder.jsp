...
<body>
                        ...
                        <table align="center" height="150">
                            ...
                            <tr>
                                <td><input name="submit" type="submit" class="button2"
                                        value="View List" />&nbsp;&nbsp;&nbsp;<input name="submit" type="submit"
                                        class="button2" value="Clear" /></td>
                            </tr>
    ...
    <div id="footer">
        ...
        <p align="right">
            <font color="Blue" size="2"><strong>Online Social Network</strong></font>
