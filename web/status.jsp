...
<body>
    ...
    <div id="page">
        <h2>Welcome!&nbsp;
            <font color="navy">
                <font size="5"> <%=fname%></font>
            </font>

            <font color="navy">
                <font size="5"><%=sname%></font>
            </font>
        </h2>
        ...
        <div id="leftbar" class="sidebar">
            <ul>
                <li>
                    ...
                    <ul>
                        <br><br>
                        <li><a href="friends.jsp">
                                <font color="blue" size="3">Find Friends</font>
                            </a></li>
                        <li><a href="viewrequest.jsp">
                                <font color="blue" size="3">ViewFriendRequest</font>
                            </a></li>

                        <li><a href="upload.jsp">
                                <font color="blue" size="3">Share Photo</font>
                            </a></li>
                        <li><a href="holder.jsp">
                                <font color="blue" size="3">FriendsList</font>
                            </a></li>
                        <li><a href="owner1.jsp?id=<%=(String) session.getAttribute("id") %>">
                                <font color="blue" size="3">Profile Modify</font>
                            </a></li>
                    </ul>
                </li>
...
%>
                        ...
                        <form name="f1" action="block.jsp" method="get" onsubmit="return validation();">
                            ...
                            <legend>
                                <font color="Blue"><strong>
                                        <font size="4">What's on your mind..!!</font>
                                    </strong></font>
                            </legend>
                            <table width="317" height="121" align="center">
                                ...
                                <tr>
                                    ...
                                    <td width="232" height="69"><input type="text" name="text" id="text"
                                            style="width: 300px; height: 100px;" /> </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td height="44"><input type="submit" class="button2"
                                            value="Update" />&nbsp;&nbsp;&nbsp;
            ...
            <div style="margin-top:90px; margin-bottom: -65px; ">
                <p>
                    <font color="blue">Posted By</font> &nbsp;<%=names%>
                </p>
            ...
            <div style="margin-top:90px; margin-bottom: -65px; ">
                <p>
                    <font color="blue">Directly Posted on your Wall By</font> &nbsp;<%=names%>
                </p>
                <input style="width: 300px; height: 30px;" value="<%=g%>"></input>
            </div>
    ...
    <div id="footer">
        ...
        <p align="right">
            <font color="#FFFFFF" size="2"><strong>Online Social Network</strong></font>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/icon3.jpg">&nbsp;&nbsp;&nbsp;&nbsp;<img
                src="images/icon1.jpg">&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/icon4.jpg">&nbsp;&nbsp;&nbsp;&nbsp;<img
                src="images/icon5.jpg">&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/Icon7.png" width="30" height="30">
        </p>
    </div>
