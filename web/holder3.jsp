            ...
            <div style="position:absolute; left:360px; top:520px; width: 360px; height: 166px;">
                <fieldset>
                    ...
                    <table align="center" height="150">
                        <tr>
                            <td>ImageOf <%=session.getAttribute("name1")%></td>
                        ...
                        <tr>
                            <td>
                                <a href="holder4.jsp?id1=<%=rs3.getInt("id")%>"><img
                                        src="view1.jsp?id=<%=rs3.getInt("id")%>" alt="" width="120" height="99" /></a>
                            </td>
                        ...
                        <tr>
                            <td><input name="submit" type="submit" class="button2" value="Share" /></td>
                        </tr>
                    </table>
