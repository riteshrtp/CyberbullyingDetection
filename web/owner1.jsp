...
<body>
	...
	<form name="form" ENCTYPE="multipart/form-data" action="profileinsert1.jsp" method="post"
		...
		<div id="page">
			<div id="content">
				<p>
					<font size="5"><strong>Welcome!</strong></font>
					&nbsp;
					<font color="#FF0000">
						<font size="5"></font>
					</font>
					...
					<div id="tabs">
						...
						<ul>
							...
							<li><a href="#fragment-2">
									<font color="#CC0000">Step2:</font>Profile Information
								</a></li>

							<li><a href="#fragment-3">
									<font color="#CC0000">Step3:</font>Profile Picture
								</a></li>
						...
						<div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
							...
							<p>
								<font color="#000000"><strong>
										<font size="3">&nbsp;&nbsp;&nbsp;Fill In Your Profile
											Information</font>
									</strong></font>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<font color="#FF0000">(This Information will help you find your friends)</font>
							</p>
							...
							<table width="440" height="125">
								...
								<tr>
									...
									<td width="204"><input type="text" name="secondary" id="s" size="25" value="" />
									</td>
								</tr>
								<tr>
								<tr>
									...
									<td width="204"><input type="text" name="university" id="s" size="25" value="" />
									</td>
								</tr>
								<tr>
								<tr>
									<td width="224" height="34">&nbsp;&nbsp;&nbsp;<font color="#000000">Employee</font>
									</td>
