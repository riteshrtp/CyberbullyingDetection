		...
		<div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
				...
				<fieldset>
					...
					<form name="f1" action="holder1.jsp" method="post">
						...
						<table width="188" height="121" align="center">
							...
							<tr>
								<td><input name="submit" type="submit" class="button2" value="View List" /></td>
							</tr>
			...
			<div style="position:absolute; left:360px; top:520px; width: 400px; height: 166px;">
				<fieldset>
					...
					<legend>
						<font color="Blue"><strong>
								<font size="4">Your FriendList</font>
							</strong></font>
					</legend>
	...
	try
	{
		...
		%>
					...
					<table align="center" height="185">
						<tr>
							<td height="34"><strong>RelationShip:&nbsp;&nbsp;&nbsp;<%=relationship%></strong></td>
						</tr>
				...
				%>
						<tr>
							<td height="30">Name:
								<a href="holder2.jsp?id=<%=fid%>"><strong>
										<font color="Navy"><%=rs3.getString("name")%></font>
									</strong></a>
							</td>
						</tr>
						<tr>
							<td>
								<a href="holder2.jsp?id=<%=fid%>"><img src="viewimage.jsp?id=<%=rs3.getInt("id")%>"
										alt="" width="120" height="99" /></a>
							</td>
							<td>Click the Image To View Their Profile</td>
						</tr>
						<%}
				}
				catch(Exception e3)
