...
<body>
  <%
        if(request.getParameter("message")!=null)
            out.println("<script> alert('registration is done')</script>");
%>

  <form name="form" ENCTYPE="multipart/form-data" action="profileinsert.jsp" method="post"
          ...
          <div id="tabs">
            ...
            <ul>
              ...
              <li><a href="#fragment-2">
                  <font color="#CC0000">Step1:</font>Profile Information
                </a></li>

              <li><a href="#fragment-3">
                  <font color="#CC0000">Step2:</font>Profile Picture
                </a></li>
            ...
            <div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
              ...
              <p>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <font color="#FF0000"><br>(This Information will help you find your friends)</font>
              </p>
