...
<body>
	...
	<div id="page">
		...
		<div style="position:absolute; right:60px; top:145px; left: 760px; width: 325px; height: 421px;">
			<p>
				<font color="blue" size="5"><strong>SignUp:</strong></font>
			</p>
 ...
 Connection con=null;
	...
	%>
					...
					<tr>
						<td height="39" class="paragraping1">
							<font color="Blue">Date Of Birth:
						</td>
...
<td><select name="type"  style="background-color:#A4E4F5;">
  ...
  <tr>-->
					...
					<td><input name="submit" type="submit" class="button2"
							value="SignUp" />&nbsp;&nbsp;&nbsp;&nbsp;<input name="reset" type="reset" class="button2"
							value="Clear" />
					</td>
					</tr>
					<%
  ...
  %>
		...
		<div id="content1" align="left">
			<div class="post">
				...
				<p align="left"><strong>
						<font color="#000000">MPAC:OSN Network</font>
					</strong></p>
