...
%>
				...
				<div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
					...
					<fieldset>
						...
						<table align="center" height="150">
							...
							<tr>
							<tr>
								<td><img src="view.jsp?id=<%=(Integer)(session.getAttribute("pid"))%>" alt=""
							...
							<tr>
								<td>
									<font color="Blue" size="+1"><strong><%=session.getAttribute("user")%> Can view this
											photo</strong></font>
								</td>
							</tr>
							<tr></tr>
 ...
 //end friends view
  %>
							<tr>
								<td>
									<font color="Blue" size="+1"><strong><%=countfds%> Friends can view this
											photo</strong></font>
								</td>
							</tr>
							<tr></tr>
							...
							<tr>
								<td>
									<font color="Blue" size="+1"><strong><%=countfly%> Family can view this
											photo</strong></font>
								</td>
							</tr>
						</table>
