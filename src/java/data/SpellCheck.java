...
public class SpellCheck {
    ...
    final static String filePath = "C:\\Documents and Settings\\rtp\\Desktop\\swearwords.txt";
    ...
    private ArrayList<String> charAppended(String input) {
        ...
        for (char c : alphabet) {
          ...
          String atMid=input.substring(0,1)+c+input.substring(1);
         // String str1=input.charAt(0)+""+c+input.substring(1);
//          String atMid=input.charAt(0) +c+input.substring(1);
    ...
    private ArrayList<String> charMissing(String input) {
        ...
        for (int i = 1; i < len; i++) {
            ...
            if (dict.contains(working)) {
                System.out.println("Working string"+working);
