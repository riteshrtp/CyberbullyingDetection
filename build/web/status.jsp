...
%>
    <body>
        ...
        <div id="content"> <div id="content">
            ...
            <div style="position:absolute; left:500px; top:255px;"><font color="Blue" size="5"><font color="red"> 
               ...
               <fieldset>
                <div style="position:absolute; left:400px; top:341px; width: 358px; height: 140px;">
                    <form name="f1" action="block.jsp" method="get" onsubmit="return validation();">
                            ...
                            <legend><font color="Blue"><strong><font size="4">What's on your mind..!!</font></strong></font></legend>
