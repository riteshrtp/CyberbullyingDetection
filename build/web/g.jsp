<%@page import="databaseconnection.constants"%>
...
int blockeduser=Integer.parseInt(buid);
 ...
 final CategoryDataset dataset = 
   DatasetUtilities.createCategoryDataset("User ", "", data);
 ...
 final CategoryAxis3D categoryAxis = new CategoryAxis3D("Users");
 ...
 final File file1 = new File(cons.file+"3dbarchart.png");
...
<html>
  ...
  <body>
  <IMG SRC="images/3dbarchart.png" 
  WIDTH="600" HEIGHT="400" BORDER="0" USEMAP="#chart">
  <br>
  <a href="adminuser.jsp">Back</a>
  </body>
</html>